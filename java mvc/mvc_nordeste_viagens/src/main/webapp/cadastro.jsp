...
<div class="container main-content">
  ...
  <form name="cadastro" action="CadastroController" method="post" class="login-form">
    <div class="row">
      <div class="col-md-6">
        <div class="mb-3">
        ...
        <div class="mb-3">
          <div class="col-md-4">
            ...
            <input type="date" class="form-control" id="bornDate" name="bornDate" required>
      ...
      <div class="col-md-6">
        <div class="col-md-8">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="tel" name="tel" required pattern="\d{1,16}">
